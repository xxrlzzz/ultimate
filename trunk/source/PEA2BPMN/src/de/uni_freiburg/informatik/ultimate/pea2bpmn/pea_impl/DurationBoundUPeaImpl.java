...
public class DurationBoundUPeaImpl extends AbsPeaImpl<DurationBoundUPattern> {
    ...
    public PEAFragment generate() {
        ...
        CDD consDr = RangeDecision.create(rClock, RangeDecision.OP_LT, c1);

        Phase pr = new Phase(id + "_st1", R, consDr);
        Phase p_true = new Phase(id + "_st2", CDD.TRUE);
        pr.addTransition(pr, consDr, new String[]{});
        p_true.addSelfTrans();
