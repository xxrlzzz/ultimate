...
public class PeaToBPMN implements IGenerator {
	private ILogger mLogger;
	private final List<String> mFileNames = new ArrayList<>();
	private IUltimateServiceProvider mServices;

	private PeaToBPMNObserver mObserver;
	...
	public IPreferenceInitializer getPreferences() {
		return new Pea2BPMNPreferences();
	}
	...
	public List<IObserver> getObservers() {
		mObserver = new PeaToBPMNObserver(mLogger, mServices);
