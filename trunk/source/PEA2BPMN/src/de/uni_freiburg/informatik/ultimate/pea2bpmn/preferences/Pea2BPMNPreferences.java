 ...
 */
package de.uni_freiburg.informatik.ultimate.pea2bpmn.preferences;
 ...
 *
 */
public class Pea2BPMNPreferences extends UltimatePreferenceInitializer {
	...
	public static final String LABEL_GEN_BPMN = "Generate BPMN from requirement";
	private static final boolean DEF_GEN_BPMN = true;
	private static final String DESC_GEN_BPMN = "gen bpmn";

	public static final String LABEL_SAVE_DIR = "Save tmp file?";
	private static final boolean DEF_SAVE_DIR = false;
	...
	protected UltimatePreferenceItem<?>[] initDefaultPreferences() {
		return new UltimatePreferenceItem<?>[] {
			new UltimatePreferenceItem<>(LABEL_GEN_BPMN, DEF_GEN_BPMN, DESC_GEN_BPMN, PreferenceType.Boolean),
